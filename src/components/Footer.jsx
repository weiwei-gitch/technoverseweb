        ...
        <div className="section-container">
          <div className="cta-box-glass">
            ...
            <p className="cta-subtitle">
              Step into <strong>TECHNOVERSE 2.O</strong> — join hundreds of innovators turning bold ideas into validated, market-ready real-world products.
            </p>
        ...
        <div className="section-container">
            ...
            <div className="footer-meta-col">
              ...
              <div className="system-telemetry-box">
                <div className="sys-row">
                  <span>EDITION:</span>
                  <strong className="text-cyan">TECHNOVERSE 2.O</strong>
                </div>
                <div className="sys-row">
                  <span>STATUS:</span>
          ...
          <div className="footer-bottom-strip">
            <div className="footer-copy-text">
              © 2026-2027 <strong>TECHNOVERSE 2.O</strong>. Presented by <strong>ACM Student Chapter, Banasthali Vidyapith</strong>. All rights reserved.
            </div>
