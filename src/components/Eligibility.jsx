  ...
  const criteria = [
    {
      ...
      summary:
        "Open to all Banasthali Vidyapith students across every department, batch, and branch.",
      bullets: [
    ...
    },
    {
      ...
      summary:
        "Sign up independently as a solo innovator or register as a complete squad.",
      bullets: [
    ...
    },
    {
      ...
      summary:
        "Optimal squad sizing engineered for balanced development velocity and cross-domain synergy.",
      bullets: [
      ...
      <div className="section-container">
        ...
        <div className="section-header-row">
          ...
          <h2 className="section-title">
            ...
            <span className="text-gradient-cyan">THINKER</span>.
          </h2>

          <p className="section-lead-text">
            TECHNOVERSE 2.O welcomes innovators from all academic domains to
            engineer holistic, multi-faceted solutions.
          </p>
        </div>
          ...
          {criteria.map((item, idx) => (
            ...
            >
              <div className="elig-card-hud-top">
                <span className="elig-code-badge">
                  {item.code}
                </span>

                <span className="elig-tag">
                  PROTOCOL 0{idx + 1}
                </span>
              </div>

              <div className="elig-icon-box">
                {item.icon}
              </div>

              <h3 className="elig-card-title">
                {item.title}
              </h3>

              <p className="elig-card-summary">
                {item.summary}
              </p>
